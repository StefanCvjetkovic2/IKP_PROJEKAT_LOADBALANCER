...
#include "Queue.h"
#include <iostream>  // Za koriš?enje cout
using namespace std;
...
QUEUE* init_queue(int capacity) {
    ...
    // Inicijalizacija kriti?ne sekcije za sinhronizaciju u više niti
...
void delete_queue(QUEUE* q) {
    if (q == NULL) {
        return;  // Ako je pokaziva? NULL, nema šta da se briše
    }
